...
export class EditTimeTracker implements OnInit {
    ...
    msg: string;
    constructor(private dialogRef: MatDialogRef<EditTimeTracker>, private fb: FormBuilder, private absenceService: AbsenceService,
    ...
    onUpdateTimeTracker(timeTrackerDetail: TimeClock) {
        ...
        this.absenceService.Patch('/Absence/updateAbsence/', TimeModel).subscribe((respose: any) => {
            if (respose == "success") {
